...
/**
 The maximum overall calendar height when expanding with `FSCalendarScopeMaxHeight`.
 */
@property (assign, nonatomic) IBInspectable CGFloat maxHeight;
